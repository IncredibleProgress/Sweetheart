...
Sweetheart implements a Python/React centric approach leading you implementing best components and best practices. Due to the top-rated place of the Python language regarding to data processing, calculations and AI, this makes sweetheart a fast and ideal toolkit for innovative ideas.
...
## Get full benefits of coding, including AI
...
no commercial dependencies are required or needed for using it,
and it comes too with some others pragmatic intentions :

  - it introduces a consistent way for making dev within company
  - it provides up-to-date and top-rated capabilities, ready-to-use
  - it intends at its heart to cover specific needs of the industry
  - it keeps simple dev integration into company's change strategies
  - it encourages the "1 knowledge package that covers all" idea


## Stick to worldwide best practices without thinking about it

Sweetheart is a thin-layer for going efficient and doesn't reinvent the wheel. It will transform you stepwise in a good driver and maybe in a pilot! Due to provided high quality components, a hardened configuration and the included documentation you will **learn at rocket speed to make great apps with Python and React** including up-to-date best practices and patterns. You won't learn Sweetheart itself, you will learn Python/React real coding-life like any other developer, but skipping some tedious considerations. That means especially you don't need any kind of expertise to use good things in the right way. Be quite, Sweetheart is made for low resources consumption, high security level, and best performances :
...
## Rely on rock-solid pillars and preserve innovative capabilities

### Application
#### Python - React - Typescript - TailwindCss
In addition dedicated *no-code* utilities for enterprise can be provided as charged extras.

### Basement
#### Ubuntu - NginxUnit - Rust - RethinkDB
...
### Development
Sweetheart is born for coding with some overarching considerations which are summarized within the [Zen of Sweetheart](https://github.com/IncredibleProgress/Sweetheart/blob/main/documentation/Zen%20of%20Sweetheart.md).
