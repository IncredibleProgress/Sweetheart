...
try:
    # allow BaseConfig providing templates config
    SWEETHEART_SYNTAX = BaseConfig.tmsyntax
    TEMPLATE_PATH = BaseConfig.tmpath
    ...
    verbose(f"SimpleTemplate syntax: {SWEETHEART_SYNTAX}")
    verbose(f"SimpleTemplate path: {TEMPLATE_PATH}")
