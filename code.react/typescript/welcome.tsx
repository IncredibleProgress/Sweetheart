...
const SvgRocket: React.FC<SvgProps> = (
  { ...props }) => {
...
const SvgIphone: React.FC<SvgProps> = (
  { ...props }) => {
    return (<svg {...props} version="1.0" 
...
const SvgGamepad: React.FC<SvgProps> = (
  { ...props }) => {
    return (<svg {...props} version="1.0"
      width="800px" height="800px" viewBox="0 0 64 64" enable-background="new 0 0 64 64">
    <g>
...
const SvgPresentation: React.FC<SvgProps> = (
  { ...props }) => {
    return(<svg {...props} version="1.0" 
    width="800px" height="800px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" >
 <g>
...
const SvgBank: React.FC<SvgProps> = (
  { ...props }) => {
    return(<svg {...props} version="1.0" 
    width="800px" height="800px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" >
 <g>
...
ReactDOM.createRoot(app!).render(
  <div className="container max-w-screen-lg mx-auto">
    ...
    transition-all hover:scale-110 hover:border-pink-200 hover:border-2">
      ...
      <SvgPresentation className="size-1/4 p-4" />
    </div>
    ...
    <div className="w-full h-1 bg-pink-400 mb-2" ></div>
      ...
      <h5 className="text-md mt-2">acknowledgments</h5>
        ...
        <p className="w-full text-justify px-2 mb-4">
          ...
          Now discover what you really can do with computers and furthermore at rocket speed !
